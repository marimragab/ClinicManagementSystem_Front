...
export class ClinicsListComponent implements OnInit {
  displayedColumns: string[] = ['_id', 'city', 'street', 'building',
                                'mobilePhone', 'doctors', 'manager', 'availability','details','edit','delete'];
 ...
 public dataSource!: MatTableDataSource<Clinics>;
  ...
  ngOnInit(){
    this.clinicsservices.getAllClinc().subscribe(data=>{
       this.clinic=data;
      // console.log( data);
...
open(){
  ...
  constructor(public clinicsservices : ClinicServicesService, private _dialog : MatDialog ){}
